...
public class FormControlTypeCombo extends javax.swing.JPanel {
    
    /** Creates new form ReportInitialPage */
    public FormControlTypeCombo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTextField1.setCaption("Items");
        xTextField1.setName("control.items");
        xTextField1.setPreferredSize(new java.awt.Dimension(0, 19));
        xTextField1.setTextCase(com.rameses.rcp.constant.TextCase.NONE);
        xFormPanel1.add(xTextField1);

        xTextField2.setCaption("Item Key");
        xTextField2.setName("control.itemKey");
        xTextField2.setPreferredSize(new java.awt.Dimension(0, 19));
        xTextField2.setTextCase(com.rameses.rcp.constant.TextCase.NONE);
        xFormPanel1.add(xTextField2);

        xTextField3.setCaption("Item Label");
        xTextField3.setName("control.itemLabel");
