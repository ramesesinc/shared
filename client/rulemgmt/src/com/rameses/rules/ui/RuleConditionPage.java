...
public class RuleConditionPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xLabel1.setExpression("#{fact.name}");
        xLabel1.setName("selectedFact.name");
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            ...
                            .add(org.jdesktop.layout.GroupLayout.LEADING, layout.createSequentialGroup()
                                ...
                                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(layout.createSequentialGroup()
                                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                        .add(xLabel6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE))
                                    .add(layout.createSequentialGroup()
                                        .add(8, 8, 8)
                                        .add(xSubFormPanel2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)))))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)))
                .addContainerGap())
        );
